...
hosts.forEach(function (host) {
    ...
    describe(`Test ${host} Task Pane Project`, function () {
        before(`Setup test environment and sideload ${host}`, async function () {
            ...
            await startDebugging(manifestPath, AppType.Desktop, toOfficeApp(host), undefined,
                undefined, devServerCmd, devServerPort, undefined, undefined, undefined, false /* enableDebugging */);
        }),
